...
/* IMPORTANT: <stddef.h> must come BEFORE any m2mb header. This project is
 * compiled as C++ (-x c++), and m2mb_types.h defines NULL as ((void*)0),
 * which C++ cannot assign to typed pointers. Including a standard header
 * first makes the compiler's own NULL win (m2mb_types.h guards with
 * #ifndef NULL) -- same reason the original main.c worked: it included
 * <stdio.h> before the m2mb headers. */
#include <stddef.h>
